                                ...
                                <form class="form-signin" action="DispatchServlet" method="POST">
                                    ...
                                    <div class="form-label-group">
                                        <input type="text" id="inputUserID" name="userID" 
                                               value="${Encode.forHtmlAttribute(param.userID)}"
                                               class="form-control"
                                               placeholder="User ID" required autofocus minlength="3" maxlength="10">
                                    ...
                                    <div class="form-label-group">
                                        <input type="text" id="inputFullName" 
                                               name="fullname" value="${Encode.forHtmlAttribute(param.fullname)}" class="form-control" 
                                    ...
                                    <div class="form-label-group">
                                        <input type="phone" id="inputPhone" 
                                               name="phone" value="${Encode.forHtmlAttribute(param.phone)}" class="form-control" 
                                    ...
                                    <div class="form-label-group">
                                        <input type="email" id="inputEmail" 
                                               name="email" value="${Encode.forHtmlAttribute(param.email)}" class="form-control" 
                                    ...
                                    <div class="form-label-group">
                                        <input type="address" id="inputAddress" 
                                               name="address" value="${Encode.forHtmlAttribute(param.address)}" class="form-control" 
